module.exports = {
  ...
  execute(client, message, args, Discord) {
    if (message.channel.name.includes("casino")) {
      const fs = require("fs");
      ...
      if (userExists) {
        ...
        if (!isNaN(amount)) {
          if (amount > gambler.coins) {
            ...
            invalidGambleEmbed.setTitle(
              "You can't gamble coins you don't have!"
            );
            ...
            invalidGambleEmbed.setThumbnail(
              "https://img.pngio.com/pixel-coin-png-png-collections-at-sccprecat-pixel-coin-png-1800_1900.png"
            );
            ...
            if (profit < 0) {
              ...
              gambleEmbed.setTitle(
                "Well, you didn't lose... :woman_shrugging:"
              );
              gambleEmbed.setDescription(
                "Proft: " + profit + "\nCoins: " + gambler.coins
              );
      ...
      var invalidChannel = new Discord.MessageEmbed();
      invalidChannel
        .setTitle("You can't use this here!")
        .setDescription(
          "Please go to the casino channel to use this command :)"
        )
        .setColor("#ea5a5a");

      message.channel.send(invalidChannel);
    }
